...
$string['modulename_help'] = '<p>Lets participants create and select groups. Features: </p><ul><li>Participant can create groups, give them a description</li><li>Participants can ask to join groups</li><li>Groups can be autocompleted</li><li>Students can make contracts</li></ul>';
...
$string['whencontracts'] = 'When are contracts available?';
