...
class mod_findpartner_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $mform->addElement('text', 'name', get_string('findpartnername', 'mod_findpartner'), array('size' => '64'));
        ...
        $mform->addHelpButton('name', 'findpartnername', 'mod_findpartner');
        ...
        $mform->addRule(array('maxmembers', 'minmembers'),
