...
$string['membershelp'] = 'You can select more than one student to the workblock. To do this you have drag the mouse in the students you want.';
$string['membershelp_help'] = 'You can select more than one student to the workblock. To do this you have drag the mouse in the students you want.';
